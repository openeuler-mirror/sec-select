//! macOS Sandbox sandbox support for SecAFS.
//!
...
//!     mountpoint: PathBuf::from("/Users/me/.secafs/run/abc/mnt"),
...
/// Generate a Sandbox profile for SecAFS.
///
...
/// - Explicitly allowed paths (e.g., ~/.config, ~/.cache, etc.)
///
