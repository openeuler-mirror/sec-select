...
/// List all currently mounted secafs filesystems (Linux)
#[cfg(target_os = "linux")]
...
/// List all currently mounted secafs filesystems (macOS stub)
#[cfg(target_os = "macos")]
...
/// Prune unused secafs mount points.
///
/// Finds all mounted secafs filesystems that are not in use by any process
/// and unmounts them.
#[cfg(target_os = "linux")]
...
/// Prune unused secafs mount points (macOS stub).
#[cfg(target_os = "macos")]
