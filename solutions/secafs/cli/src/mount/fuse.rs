...
pub(super) fn mount_fuse(
    fs: Arc<Mutex<dyn secafs_sdk::FileSystem + Send>>,
    opts: MountOpts,
) -> Result<MountHandle> {
    ...
    let fs_arc: Arc<dyn secafs_sdk::FileSystem> = Arc::new(fs_adapter);

    let fuse_handle = std::thread::spawn(move || {
        let rt = crate::get_runtime();
        crate::fuse::mount(fs_arc, fuse_opts, rt, 1)
    });
...
struct MutexFsAdapter {
    inner: Arc<Mutex<dyn secafs_sdk::FileSystem + Send>>,
}

#[async_trait::async_trait]
impl secafs_sdk::FileSystem for MutexFsAdapter {
    async fn lookup(
        &self,
        parent_ino: i64,
        name: &str,
    ) -> std::result::Result<Option<secafs_sdk::Stats>, secafs_sdk::error::Error> {
    ...
    async fn readlink(
        &self,
        ino: i64,
    ) -> std::result::Result<Option<String>, secafs_sdk::error::Error> {
    ...
    async fn readdir(
        &self,
        ino: i64,
    ) -> std::result::Result<Option<Vec<String>>, secafs_sdk::error::Error> {
    ...
    async fn readdir_plus(
        &self,
        ino: i64,
    ) -> std::result::Result<Option<Vec<secafs_sdk::DirEntry>>, secafs_sdk::error::Error> {
    ...
    async fn chmod(
        ...
        ino: i64,
        mode: u32,
    ) -> std::result::Result<(), secafs_sdk::error::Error> {
    ...
    async fn utimens(
        &self,
        ino: i64,
        atime: secafs_sdk::TimeChange,
        mtime: secafs_sdk::TimeChange,
    ) -> std::result::Result<(), secafs_sdk::error::Error> {
    ...
    async fn open(
        ...
        ino: i64,
        flags: i32,
    ) -> std::result::Result<secafs_sdk::BoxedFile, secafs_sdk::error::Error> {
    ...
    async fn mkdir(
        ...
        uid: u32,
        gid: u32,
    ) -> std::result::Result<secafs_sdk::Stats, secafs_sdk::error::Error> {
        self.inner
            .lock()
            .await
    ...
    async fn create_file(
        ...
        uid: u32,
        gid: u32,
    ) -> std::result::Result<(secafs_sdk::Stats, secafs_sdk::BoxedFile), secafs_sdk::error::Error>
    {
        self.inner
            .lock()
            .await
    ...
    async fn statfs(
        &self,
    ) -> std::result::Result<secafs_sdk::FilesystemStats, secafs_sdk::error::Error> {
