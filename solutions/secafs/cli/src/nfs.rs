//! NFS server adapter for SecAFS.
//!
//! This module implements nfsserve's NFSFileSystem trait on top of SecAFS's
//! FileSystem trait, enabling systems to mount SecAFS via NFS without requiring
...
/// NFS adapter that wraps a SecAFS FileSystem.
pub struct AgentNFS {
...
impl AgentNFS {
    ...
    /// Convert SecAFS Stats to NFS fattr3.
