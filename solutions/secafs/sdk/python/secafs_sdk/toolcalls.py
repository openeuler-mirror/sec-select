...
class ToolCalls:
    """Tool calls tracking backed by the SecAFS database
    ...
    @staticmethod
    async def from_database(db: DbConnection, skip_schema_init: bool = False) -> "ToolCalls":
    ...
    async def start(self, name: str, parameters: Optional[Any] = None) -> int:
        ...
        Note: Uses RETURNING clause for Postgres compatibility.
        """
